...
<form action="diario_bs.php" method="post">

      Busqueda por Fecha : 
      <input class="form-control" type="date" value="Ingrese el nombre..." aria-label="readonly input example" name="Fecha" id="formulario"></br>
